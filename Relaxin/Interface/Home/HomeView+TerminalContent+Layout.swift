...
extension RelaxinTerminalContent {
    ...
    static func baseLines(
        isJailbroken: Bool,
        additionalReport: [(String, String)] = [],
    ...
    static func bannerLines(
        ...
        // Keep the upstream Relaxin half-block banner intact and extend it
        // with the matching -X glyph while preserving the original two-row rhythm.
        let bannerTop = "█▀█ █▀▀ █   ▄▀█ ▀▄▀ █ █▄ █   ▀▄▀"
        let bannerBottom = "█▀▄ ██▄ █▄▄ █▀█ █ █ █ █ ▀█ ▀ █ █"
        ...
        return [
            ...
            TerminalStyle.dim(
                String(
                    localized: "Runtime support is resolved for this device",
